  ...
  .container
    ...
    .apply-content__wrapper
      .apply-block__wrapper
        ...
        .apply-right.human-info.vacancy-application
          .input_item
            .info-label
              | Имя и фамилия 
      ...
      .apply-block__wrapper.letter
        .apply-left
          .info-left_title
            | Описание вакансии
          .info-left_subtitle
            | Расскажите нам о вашей вакансии
        .apply-right
          <textarea name="text"></textarea>

          <input type="submit" class="apply-submit vacancy_application-btn">    
...
input.apply-submit.vacancy_application-btn {
  display: block;
  margin-left: auto;
  padding-left: 0;
  margin-top: 32px;
...
@media (max-width: 1200px) {
  .apply-right.human-info.vacancy-application .input_item:nth-child(2n) {
    margin-left: 0;
  }
  .apply-left.empty {
    display: none;
